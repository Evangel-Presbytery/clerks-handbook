...
* **Notations**, whenever possible, should be corrected in the minutes. Such corrections typically do not require review or action by the session, since they are typically typographical in nature and therefore do not affect the meaning of what was recorded.
...
Occasionally, the SRC will provide **recommendations** on how you can improve the [clarity](#clarity), [concision](#concision), or [consistency](#consistency) of your minutes. These are merely recommendations and do not require correction. They are offered as an aid to making your minutes more useful to your own session.