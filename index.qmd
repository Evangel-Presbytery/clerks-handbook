...
The BCO organizes Evangel Presbytery's government into two types of "court": church sessions and presbyteries ([BCO 12.1–2](https://bco.evangelpresbytery.com/form-of-government.html#church-courtsin-general)). Each of these courts must have a stated clerk who is officially responsible for its records. The presbytery as a whole has a stated clerk, and each church session is responsible for electing its own stated clerk ([BCO 6.3](https://bco.evangelpresbytery.com/form-of-government.html#the-organization-of-a-particular-church)), often referred to as the "clerk of session"; he is responsible for keeping, organizing, understanding, and furnishing the church's records:

>It is the duty of the Clerk, besides recording the transactions, to preserve the records carefully, and to grant extracts from them whenever properly required. Such extracts, under the hand of the Clerk, shall be evidence to any ecclesiastical court, and to every part of the Church. ([BCO 12.4](https://bco.evangelpresbytery.com/form-of-government.html#church-courtsin-general))
...
* [Governing Documents](#sec-governing-documents)
...
* [Organization of Records](#sec-organization-of-records)
* [Submission of Records to Presbytery](#sec-submission-of-records-to-presbytery)
* [Rules of Order for Sessions](#sec-rro-for-clerks)
