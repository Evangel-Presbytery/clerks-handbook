...
The BCO organizes Evangel Presbytery's government into "courts": "These courts are church Sessions and Presbyteries" ([BCO 12.1–2](https://evangel.pressbooks.com/chapter/12-church-courts-in-general/)). Each of these courts must have a stated clerk who is responsible for the court's records. The presbytery as a whole has a stated clerk, and each church session is responsible for electing its own stated clerk ([BCO 6.3](https://evangel.pressbooks.com/chapter/6-the-organization-of-a-particular-church/)).
...
It is common for the stated clerk to delegate some of his duties to other individuals, especially in the context of a larger church or session, where the keeping of records is more complex. In particular, the task of keeping minutes is often delegated to a *recording clerk*, or *clerk pro tem*, as it can be difficult to participate in a meeting while also recording the meeting's proceedings.

The clerk will also often employ other individuals in keeping records for committees, subcommittees, or other boards of the church. For instance, the clerk should normally rely on the secretary of the board of deacons to keep good records for the deacons.

Even when help from others is utilized, the stated clerk is still finally responsible for compiling the records kept and for ensuring their accuracy. He should make sure to review all records, including those which are kept by someone he has delegated.