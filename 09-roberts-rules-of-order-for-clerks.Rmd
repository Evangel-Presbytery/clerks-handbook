...
Robert's Rules is actually a pretty quick read for how thick it is. You can probably get through it in 4 hours. Some sections only apply to larger assemblies--skim over those sections. But put the time in---who else on the board is going to do it? And it will be helpful.
