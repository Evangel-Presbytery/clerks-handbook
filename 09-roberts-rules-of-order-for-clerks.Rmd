...
The following is a mix of Robert's Rules and general advice regarding good order. The parts that are from Robert's Rules are cited. All such citations are from the 12th edition of *Robert's Rules of Order Newly Revised* (RONR). You can get the authoritative edition [here](https://robertsrules.com/books/newly-revised-12th-edition/). We encourage clerks to get it and read it. There is also an abbreviated edition, [*Robert's Rules of Order In Brief*](https://robertsrules.com/books/newly-revised-3rd-in-brief-edition/).

## Important Terms for Sessions

* **M/S/A, short for Moved, Seconded, Approved** – This tends to be the most frequent application of Robert's Rules in session meetings. The normal process is for a member of the session to move that the board take some action. The motion then requires a second from another member of the session (but see [Small Boards] below); only after a second can the motion be discussed. After discussion (if there is any), the session votes on whether or not to approve the motion.
* **Consensus** – This is the generally expressed will of the session, and can be used to take official action. Which is to say, not every action needs to be M/S/A, especially in [Small Boards].
...
* **Orders of the Day** – This helps ensure that [agenda](Following the Agenda) items that are pre-agreed on happen at a certain time. It is commonly used to set a standard meeting end time. If an end time has been set, and that time is reached, a member may move to extend orders of the day by a certain amount of time in order for discussion to continue (see RONR 41:41). (See [Orders of the Day] below.)
...
* Motions do not need a second (though see below about [custom](Custom)).
