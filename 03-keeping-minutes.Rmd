...
Minutes are intended to record essential information only. They should not be a detailed play-by-play of deliberation. The most important thing to record in minutes is any official action taken by the session. For example, it is not necessary to record every amendment that is made to a motion before it is finally voted on and approved. It is only necessary to record the motion in its final form. For more information on good order in session meetings, see [Robert's Rules of Order for Clerks].
...
<div class="copyable">
<p>Name of Church, Board, Committee, Commission, etc.<br />
Purpose of Meeting, often “Regular Scheduled Session Meeting”<br />
Time, Date, Year<br />
Location (and/or virtual app used for meeting remotely)<br /><br /></p>

<p>Present: Name (position related to body meeting), …<br /><br /></p>

<p>Excused absences: Name (position related to the body meeting), …<br /><br /></p>

<p>1.\ ——— led devotions from ———, [brief summary]. ——— opened the meeting in prayer at #:## am/pm.<br /><br /></p>

<p>2.\ Clerk’s business<br /><br /></p>

<p class="level2">a.\ Establishment of quorum<br /><br /></p>

<p class="level2">b.\ Adoption of previous meeting minutes<br /><br /></p>

<p class="level2">c.\ Recording of any actions taken by email between meetings, if applicable<br /><br /></p>

<p class="level2">d.\ Attendance, membership, statistics, etc.<br /><br /></p>

<p class="level2">e.\ Celebration of sacraments<br /><br /></p>

<p class="level3">i.\ Lord's Supper<br /><br /></p>

<p class="level3">ii.\ Baptisms<br /><br /></p>

<p>3.\ Action item review<br /><br /></p>

<p>4.\ Treasurer’s report<br /><br /></p>

<p>5.\ Pastoral care<br /><br /></p>

<p class="level2">a.\ …<br /><br /></p>

<p class="level2">b.\ …<br /><br /></p>

<p>\#.\ …<br /><br /></p>

<p>\#.\ Next meeting set for [Time, Date, Year], at [Location]. ——— will lead devotions.<br /><br /></p>

<p>Meeting adjourned at #:## am/pm.<br /><br /></p>

<p>Respectfully submitted,<br />
———<br />
Stated Clerk (or Clerk pro tem)<br />
Name of Body Meeting</p>
</div>
...
* Leave out all but the barest level of detail. If during discussion someone expresses the worry, "He'll never listen if we tell him that," DON'T write down "The board believes X will never listen if we tell him Y." Just leave it out.

### Minutes: accessibility to people not on the board
Be aware that your church's bylaws may specify that the minutes are a public record of the meeting that any member of the church is entitled to receive a copy of. So the first time you use an acronym in the minutes of a meeting you should spell it out. For instance, you and your board may know what you mean by "CGELA", but nobody else does. You should spell out "Chapel Glen Early Learning Academy (CGELA)" the first time it occurs in the minutes of a meeting. After that you can use CGELA.
