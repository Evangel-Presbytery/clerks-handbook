...
Evangel Presbytery's official standards for keeping minutes can be found in [Appendix\ 1 of the presbytery's bylaws](https://evangelpresbytery.com/wp-content/uploads/2021/06/EvangelPresbyteryBylaws_2021_06_03.pdf). The information included in this section of the handbook is intended to supplement the presbytery's standards without adding further requirements.
...
6. **File newly adopted minutes with the [permanent record](https://clerks.evangelpresbytery.com/keeping-minutes.html#the-permanent-record) of minutes immediately after the meeting where they are officially adopted.** For good filing practices, see [Organization of Records].
...
1. Click [**here**](https://github.com/Evangel-Presbytery/clerks-handbook/raw/main/Download%20Files/Evangel%20Sample%20Session%20Meeting%20Minutes.pdf) to download a sample set of **session meeting minutes**.
2. Click [**here**](https://github.com/Evangel-Presbytery/clerks-handbook/raw/main/Download%20Files/Evangel%20Sample%20Congregational%20Meeting%20Minutes.pdf) to download a sample set of **congregational meeting minutes**.
